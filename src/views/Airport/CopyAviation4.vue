    ...
    <el-dialog :visible.sync="dialogVisible" width="60%" title="制单"  class="makeFormStyle">
      <el-form :model="addForm" ref="addForm" size="mini" :rules="addFormRules" id="print_content">
        ...
        <div class="formBorder">
          ...
          <el-row>
            <el-col :span="2" class="col_body" @click.native="changeRcpStatus">
              <el-input v-if='rcpVisible' v-model="addForm.rcp" size="mini" @blur="blurRcp" ></el-input>
              <span v-else>{{addForm.rcp}}</span>
            </el-col>
            <el-col :span="3" class="col_body">
              <el-select v-model="addForm.itemnum" size="mini">
            ...
            <el-col :span="2" class="col_body">
              <span v-model="addForm.chargeweight"></span>
            </el-col>
            <el-col :span="2" class="col_body">
              <span v-model="addForm.rate"></span>
            </el-col>
            <el-col :span="2" class="col_body">
              <span v-model="addForm.weightcharge" size="mini"></span>
            </el-col>
            <el-col :span="8" class="col_body">
            </el-col>
          </el-row>
