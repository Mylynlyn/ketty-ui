      ...
      <el-form :inline="true"  :size="size">
        ...
        <el-form-item>
          <el-upload accept=".xls, .xlsx"
                     action='http://39.105.37.45:8001/receive/importExcel'
                     :headers="uploadHeaders"
                     :file-list="fileList"
                     :on-success="fileSuccess"
                     :on-error="fileError"
                     :show-file-list="false" >
            <kt-button icon="fa fa-cloud-upload" label="批量导入" perms="data:received:upload" type="primary"></kt-button>
          </el-upload>
        </el-form-item>
        <el-form-item>
          <kt-button icon="fa fa-download" label="下载模板" perms="data:received:download" type="text"
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            downloadTemplate(){
                const url=`http://39.105.37.45:8001/receive/download?token=${this.uploadHeaders.token}`
